# ADR-016: Adopt Privacy-Minimizing Visitor Analytics
...
Popularity and crowd analytics create value, but visitor movement and profile data can become sensitive when linked to identifiable individuals.
...
Prefer anonymous or pseudonymous event identifiers for attraction and movement analytics. Collect only data required for stated purposes. Separate identity, transaction, telemetry, and analytical domains. Require documented purpose, consent or other approved basis where applicable, retention limits, access controls, and deletion or anonymization processes before personalized tracking is enabled.
...
- Collect all available visitor data for future use
- Link every crowd event to a named profile
- Avoid visitor analytics entirely

## Consequences

- Analytical value is retained while reducing privacy exposure.
- Some personalization and journey analysis may have reduced precision.
- Legal, privacy, and business owners must approve data purposes and retention.
...
Function creep and re-identification are key risks. Use purpose limitation, token separation, aggregation, minimum cohort rules where appropriate, and governance review for new use cases.

## Implementation and Validation Actions

- [ ] Create a data inventory and privacy impact assessment.
- [ ] Define anonymous, pseudonymous, and identified event schemas.
- [ ] Document consent and preference journeys.
- [ ] Implement retention, subject-rights, access review, and re-identification controls.
